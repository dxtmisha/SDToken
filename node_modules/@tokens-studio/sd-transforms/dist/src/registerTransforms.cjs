    ...
    if (transformOpts?.expand !== false) {
        ...
        _sd.registerParser({
            ...
            parse: ({ filePath, contents }) => {
                ...
                const withFontStyles = addFontStyles.addFontStyles(excluded, transformOpts);
                const expanded = expandComposites.expandComposites(withFontStyles, filePath, transformOpts);
                return expanded;
            },
        });
    }

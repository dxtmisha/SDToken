...
function transformTypographyForCSS(value) {
    ...
    return `${isNothing(fontWeight) ? 400 : fontWeight}${isNothing(fontStyle) ? '' : ` ${fontStyle}`} ${isNothing(fontSize) ? '16px' : fontSize}/${isNothing(lineHeight) ? 1 : lineHeight} ${fontFamily}`;
}

export { hasWhiteSpace, isAlreadyQuoted, isCommaSeparated, processFontFamily, transformTypographyForCSS };
